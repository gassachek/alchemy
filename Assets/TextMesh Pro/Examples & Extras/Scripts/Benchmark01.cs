...
namespace TMPro.Examples
{
    ...
    public class Benchmark01 : MonoBehaviour
    {
        ...
        private Item m_material01;
        private Item m_material02;
        ...
        IEnumerator Start()
        {
            ...
            if (BenchmarkType == 0) // TextMesh Pro Component
            {
                ...
                m_material02 = Resources.Load<Item>("Fonts & Materials/LiberationSans SDF - Drop Shadow"); // Make sure the LiberationSans SDF exists before calling this...  
